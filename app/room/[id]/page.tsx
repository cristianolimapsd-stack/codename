    ...
    <aside className="flex w-full max-w-[250px] flex-col gap-4 xl:w-[250px]">
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="mt-5 rounded-[22px] border border-white/15 bg-black/12 px-4 py-6 text-center">
            <p className="text-3xl font-black uppercase tracking-[0.06em]">{agentLabel}</p>
            <button
              type="button"
              ...
              className={cn(
                ...
                me?.team === team && me?.role === 'operative' && 'ring-2 ring-white/40'
              )}
            >
              Join Team
            </button>
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="mt-5 rounded-[22px] border border-white/15 bg-black/12 px-4 py-6 text-center">
            <p className="text-3xl font-black uppercase tracking-[0.06em]">{spymasterLabel}</p>
            <button
              type="button"
              onClick={() => onPickRole(team, 'spymaster')}
              className={cn(
                'mt-5 w-full rounded-full border border-[#97db56]/50 bg-gradient-to-b from-[#2eb300] to-[#1c7d00] px-4 py-3 text-sm font-black uppercase tracking-[0.18em] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.35)] transition hover:brightness-110',
                me?.team === team && me?.role === 'spymaster' && 'ring-2 ring-white/40'
              )}
            >
              Join Team
            </button>
        ...
        <div className="mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-5 py-5">
          ...
          {spectators.length > 0 && (
            <div className="mb-6 flex flex-wrap items-center justify-center gap-2">
              <span className="text-xs font-black uppercase tracking-[0.24em] text-white/40">Espectadores</span>
          ...
          <main className="rounded-[34px] border border-white/10 bg-black/18 p-5 shadow-2xl backdrop-blur-md">
            ...
            <div className="mx-auto grid w-full max-w-[1040px] grid-cols-5 gap-4">
              {gameState.cards.map((card, index) => {
                ...
                if (card.revealed) {
                  ...
                  outerClass = 'border-white/15 bg-[#142033]'
                  innerClass = 'bg-[#15253a]'
                  labelClass = 'bg-[#24364d] text-white'
                }
                ...
                return (
                  ...
                  >
                    ...
                    {isSpymaster && !card.revealed && (
                      <span
                        className="absolute right-4 top-4 h-3.5 w-3.5 rounded-full ring-2 ring-white/25"
            ...
            {gameState.hintHistory.length > 0 && (
              <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
                <span className="text-xs font-black uppercase tracking-[0.22em] text-white/35">Historico</span>
