...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#0a1018_0%,#17273a_45%,#2a4561_100%)] text-white">
      ...
      <div className="absolute left-6 top-10 h-24 w-16 rotate-[-12deg] rounded-[18px] border border-white/10 bg-[#cf6d59]/20 shadow-2xl sm:left-10 sm:top-16 sm:h-28 sm:w-20" />
      <div className="absolute left-20 top-16 h-24 w-16 rotate-[11deg] rounded-[18px] border border-white/10 bg-[#4b90d8]/20 shadow-2xl sm:left-28 sm:top-24 sm:h-28 sm:w-20" />
      <div className="absolute bottom-10 right-8 h-24 w-16 rotate-[10deg] rounded-[18px] border border-white/10 bg-[#c8c09a]/18 shadow-2xl sm:bottom-16 sm:right-20 sm:h-28 sm:w-20" />

      <div className="relative mx-auto flex min-h-screen w-full max-w-[1400px] items-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid w-full items-center gap-8 lg:grid-cols-[1.05fr_520px]">
          <section className="max-w-[680px]">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/12 bg-[#0f1b28]/70 px-4 py-2 text-[11px] font-black uppercase tracking-[0.28em] text-white/70 backdrop-blur-md sm:text-xs">
              Tempo real
              <span className="h-2 w-2 rounded-full bg-[#4fe26d]" />
              Salas privadas
            </div>

            <h1 className="text-[clamp(3rem,14vw,7.4rem)] font-black uppercase leading-[0.9] tracking-[-0.05em]">
              <span className="text-white">Code</span>
              <span className="text-[#ff6e5c]">Names</span>
            </h1>

            <p className="mt-5 max-w-[52ch] text-base leading-8 text-white sm:text-lg">
              Monte salas tematicas, convide seus amigos e jogue uma versao mais elegante e
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5 backdrop-blur-md">
                ...
                <p className="mt-2 text-2xl font-black">Lobby rapido</p>
                <p className="mt-2 text-sm leading-6 text-white/65">
                  Crie uma sala e compartilhe o codigo.
                </p>
              </div>
              ...
              <div className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5 backdrop-blur-md">
                ...
                <p className="mt-2 text-sm leading-6 text-white/65">
                  Adicione o vocabulario que quiser.
                </p>
              </div>
            </div>
          </section>

          <section className="rounded-[30px] border border-white/10 bg-[rgba(31,49,72,0.78)] p-4 shadow-[0_25px_70px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-6">
            <div className="mb-5 rounded-[24px] border border-white/10 bg-[#1c2738] p-3">
              <input
                value={name}
                onChange={(e) => setName(e.target.value)}
                placeholder="Seu apelido de agente..."
                className="w-full rounded-[18px] border border-[#2a3444] bg-[#08111c] px-4 py-4 text-base text-white outline-none transition placeholder:text-white/25 focus:border-white/30 sm:px-5 sm:text-lg"
              />
            </div>

            <div className="mb-5 flex rounded-[20px] border border-[#101826] bg-[#08111c] p-1.5">
              <button
                onClick={() => setTab('create')}
                className={cn(
                  'flex-1 rounded-[16px] px-4 py-3 text-xs font-black uppercase tracking-[0.18em] transition sm:text-sm',
            ...
            {tab === 'create' && (
              <div className="space-y-4">
                <div className="rounded-[24px] border border-white/10 bg-[#23364b]/75 p-4 sm:p-5">
                    ...
                    {[
                      {
                        id: 'geral',
                        label: 'Geral PT-BR',
                        desc: 'Base ampla para partidas classicas',
                      ...
                      },
                      {
                        id: 'marvel-rivals',
                        label: 'Marvel Rivals',
                        desc: 'Herois, mapas, poderes e faccoes',
                ...
                <button
                  ...
                  className={cn(
                    'w-full rounded-[22px] border border-dashed p-4 text-left transition',
                    showCustom
                ...
                {showCustom && (
                  <textarea
                    ...
                    rows={4}
                    className="w-full resize-none rounded-[22px] border border-white/10 bg-[#08111c] px-5 py-4 text-white outline-none placeholder:text-white/25 focus:border-white/30"
                  />
                )}
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full rounded-[20px] border border-[#ff9d90]/35 bg-gradient-to-b from-[#df6a58] to-[#b64333] px-5 py-4 text-sm font-black uppercase tracking-[0.18em] text-white shadow-[0_16px_35px_rgba(182,67,51,0.35)] transition hover:brightness-110 disabled:opacity-50 sm:text-base"
                >
              ...
              <div className="space-y-4">
                <div className="rounded-[24px] border border-white/10 bg-[#23364b]/75 p-4 sm:p-5">
                  ...
                  <input
                    ...
                    className="w-full rounded-[20px] border border-white/10 bg-black/20 px-5 py-4 text-lg text-white outline-none placeholder:text-white/25 focus:border-white/30 sm:text-xl"
                  />
                </div>
                ...
                <button
                  onClick={handleJoin}
                  disabled={loading}
                  className="w-full rounded-[20px] border border-[#7ebfff]/35 bg-gradient-to-b from-[#4e9ae0] to-[#2d78bf] px-5 py-4 text-sm font-black uppercase tracking-[0.18em] text-white shadow-[0_16px_35px_rgba(45,120,191,0.35)] transition hover:brightness-110 disabled:opacity-50 sm:text-base"
                >
            ...
            {error ? (
              <div className="mt-4 rounded-[18px] border border-[#d85b49]/30 bg-[#d85b49]/10 px-4 py-3 text-sm font-bold text-[#ffac9f]">
                {error}
              </div>
            ) : null}

            <p className="mt-5 text-center text-[11px] uppercase tracking-[0.22em] text-white/35 sm:text-xs">
